...
import { LayoutDashboard, LogOut, PanelLeft, Users, Briefcase, FileText, Clock, DollarSign, Inbox, Activity, CheckSquare, Settings, Mail, FileStack } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Inbox, label: "Intake", path: "/intake" },
